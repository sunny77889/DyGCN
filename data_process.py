...
class Cic_Dataset():
    def __init__(self): 
        ...
        self.label_list=[]
        self.A_list=[]
        self.data_path='/home/xiaoqing/gitpro/GNNPro/DyGCN/DyGCN/data/cic/'
    ...
    def gen_graphs(self):
        ...
        print('攻击种类', Counter(df[' Label']).keys())
...
class UNSW_Dataset():
    def __init__(self):
        ...
        self.label_list=[]
        self.A_list=[]
        self.data_path='/home/xiaoqing/gitpro/GNNPro/DyGCN/compare_models/GCN_LSTM/data/unsw/'
    ...
    def gen_graphs(self):
        ...
        df = pd.concat(dataframe_list)
        a=df['attack_cat'].fillna(0)
        print('攻击种类：', Counter(a).keys())
...
class USTC_Dataset():
    def __init__(self):
        ...
        self.label_list=[]
        self.A_list=[]
        self.data_path='/home/xiaoqing/gitpro/GNNPro/DyGCN/compare_models/GCN_LSTM/data/ustc/'
...
class Cic2018_Dataset():
    def __init__(self):
        ...
        self.label_list=[]
        self.A_list=[]
        self.data_path='/home/xiaoqing/gitpro/GNNPro/DyGCN/DyGCN/data/cic2018/'
...
if __name__ =='__main__':
    ...
    parser.add_argument("--dataset", default='cic2017', type=str)
    args=parser.parse_args()
    dataset = args.dataset
    if dataset=='cic2017':
        Cic_Dataset().gen_graphs()
    elif dataset=='cic2017':
        Cic2018_Dataset().gen_graphs()
