...
class Cic_Dataset():
    def __init__(self): 
        ...
        self.label_list=[]
        self.A_list=[]
        self.data_path='/home/xiaoqing/gitpro/GNNPro/DyGCN/compare_models/GCN_LSTM/data/cic/'
...
class Cic2018_Dataset():
    def __init__(self):
        ...
        self.label_list=[]
        self.A_list=[]
        self.data_path='/home/xiaoqing/gitpro/GNNPro/DyGCN/compare_models/GCN_LSTM/data/cic2018/'
